...
def write_gcs(path: Path) -> None:
    ...
    gcp_cloud_storage_bucket_block = GcsBucket.load("de-week-two-example")
...
# prefect deployment build ./flows/04_homework/parameterized_flow_hw.py:etl_parent_flow --name de-hw-1 -a